        ...
        {view === "banner" ? (
          ...
          <>
            ...
            <p className={styles.text}>
              ...
              might be about you, your preferences or your device.
            </p>
            ...
            <div className={styles.accordionList}>
              <details className={styles.accordion}>
                ...
                <div className={styles.accordionContent}>
                  ...
                  functions like page navigation and access to secure areas. The
              ...
              <details className={styles.accordion}>
                ...
                <div className={styles.accordionContent}>
                  ...
                  for the individual user. (e.g. Facebook Pixel)
                </div>
              </details>
            </div>
