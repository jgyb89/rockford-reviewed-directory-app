    ...
    <div className={styles["step-form"]}>
      ...
      <div className={styles["step-form__group"]}>
        <label htmlFor="address" className={styles["step-form__label"]}>
          Address Street{" "}
          <span className={styles["step-form__required"]}>*</span>
        </label>
        <input
          type="text"
          id="address"
        ...
        />
        {errors.address && (
          <span className={styles["step-form__error-message"]}>
            {errors.address}
          </span>
        )}
      </div>
      ...
      >
        <div className={styles["step-form__group"]}>
          <label htmlFor="city" className={styles["step-form__label"]}>
            City
          </label>
          <input
            type="text"
        ...
        <div className={styles["step-form__group"]}>
          <label htmlFor="state" className={styles["step-form__label"]}>
            State
          </label>
          <input
            type="text"
      ...
      <div className={styles["step-form__group"]}>
        <label htmlFor="zipCode" className={styles["step-form__label"]}>
          Zip Code
        </label>
        <input
          type="text"
      ...
      <div className={styles["step-form__group"]}>
        <label htmlFor="email" className={styles["step-form__label"]}>
          Email Address
        </label>
        <input
          type="email"
      ...
      <div className={styles["step-form__group"]}>
        <label htmlFor="website" className={styles["step-form__label"]}>
          Website URL
        </label>
        <input
          type="url"
      ...
      <div className={styles["step-form__group"]}>
        <label htmlFor="socialUrl" className={styles["step-form__label"]}>
          Social Media URL
        </label>
        <input
          type="url"
